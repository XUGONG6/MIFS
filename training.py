...
class MolEN(object):
    ...
    def train(self):
        ...
        if self.config['model_type'] == 'MolEN':
            from models.MolEN import *
            args = parse_arguments()
            model = MolEN(args.num_layer, args.emb_dim, args.heads, args.num_message_passing, args.dropout_ratio)
        else:
